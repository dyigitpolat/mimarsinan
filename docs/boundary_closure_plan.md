...
| Message granularity | pinned empirically against a sealed SANA-FE trace; documented in the estimator | estimator | parity test: estimator fed measured per-source spike counts reproduces the sealed NoC census |
