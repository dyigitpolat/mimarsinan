...
| P5.5 synthesis/implementation gate + resource table | split: **P5.5a** (in flight) = local yosys `synth_xilinx` proof + the per-core resource table (P8's input); **P5.5b** = Vivado/U55C-shell implementation closure, folded into P7's HACC build — Vivado exists only on HACC and login is owner-gated 2FA | |
