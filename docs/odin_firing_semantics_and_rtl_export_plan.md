...
| P5 vendored RTL + cosim harness (semantic-equivalence gate R11a) | open — **merged-tree baseline for P3/P5: 12,836 passed / 32 skipped / 0 failed ~57 s, typecheck 0, budgets 0** (merges 353653a0 + 37902e3a) | |
