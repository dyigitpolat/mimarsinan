...
fixed-ladder fast driver. The blend/proxy variants walk the multi-rung ladder, with
the proxy flooring the endpoint LR. The rung derivation lives (and is tested) in one
place.
"""
