...
| `test_controller_invariants.py` | RateScheduler over each archetype: lands within the feasible edge (I1), monotone progress (I2), bounded probes, partial-result on recovery-limited. |
