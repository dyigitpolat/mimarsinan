...
When allow_core_coalescing is True, wide layers (in_features > max_axons) 
...
def _make_mapping(
    *,
    ...
    allow_core_coalescing: bool = True,
...
class TestCoreCoalescing:
    def test_coalesced_core_is_wide(self):
        ...
        m = _make_mapping(max_axons=20, max_neurons=64, allow_core_coalescing=True)
    ...
    def test_coalescing_tiles_outputs_when_necessary(self):
        ...
        m = _make_mapping(max_axons=20, max_neurons=32, allow_core_coalescing=True)
