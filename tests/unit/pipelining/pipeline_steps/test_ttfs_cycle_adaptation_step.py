...
class TestCascadedGradualRamp:
    ...
    model runs the deployed dynamics). The genuine blend ramp that trains
    through the deployed cascade for the whole ramp is the OPT-IN
    (``ttfs_genuine_blend_ramp``, default off)."""
