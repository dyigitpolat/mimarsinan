...
class NoiseTuner(BasicTuner):
    ...
    def _update_and_evaluate(self, rate):
        for perceptron in self.model.get_perceptrons():
            perceptron.set_regularization(NoisyDropout(0.0, rate, self.target_noise_amount * perceptron.base_threshold))
    ...
    def run(self):
        ...
        for perceptron in self.model.get_perceptrons():
            perceptron.set_regularization(NoisyDropout(0.0, 1.0, self.target_noise_amount * perceptron.base_threshold))
