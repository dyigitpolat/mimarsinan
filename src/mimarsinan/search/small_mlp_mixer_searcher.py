...
from mimarsinan.search.small_mlp_mixer_configuration_sampler import Small_MLP_Mixer_ConfigurationSampler
from mimarsinan.models.perceptron_mixer.small_perceptron_mixer import SmallPerceptronMixer

import json
class Small_MLP_Mixer_Searcher(BasicArchitectureSearcher):
    def __init__(self, input_shape, num_classes, max_axons, max_neurons, evaluator):
        super().__init__()
        self.configuration_sampler = Small_MLP_Mixer_ConfigurationSampler()
    ...
    def _create_model(self, configuration):
        ...
        perceptron_flow = SmallPerceptronMixer(
