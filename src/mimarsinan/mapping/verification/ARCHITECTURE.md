...
| `wizard_layout_verify.py` | Wizard entry | GUI/wizard layout verify. Snapshot-side degradation (warm-up forwards, `model_repr_from_model`) goes through `common.best_effort`; verification itself fails loud. |
