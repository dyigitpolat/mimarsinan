...
class ModelRepresentation:
    def __init__(self, output_layer_mapper):
        ...
        self._exec_order: list | None = None
    ...
    def _ensure_exec_graph(self) -> tuple[list, dict, dict]:
        ...
        if (
            self._exec_order is not None
            and self._deps is not None
            and self._consumer_count is not None
        ):
            return self._exec_order, self._deps, self._consumer_count
    ...
    def __call__(self, x):
        ...
        exec_order, deps_map, consumer_count = self._ensure_exec_graph()
