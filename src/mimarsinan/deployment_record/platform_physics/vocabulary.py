...
ROWS: Tuple[Tuple[str, str, str, str, str, str], ...] = (
    ...
    ("area_per_cell", ARRAY, AREA, "um^2", "utilization.crossbar.cells_physical",
    ...
    ("area_per_cell_per_weight_bit", ARRAY, AREA, "um^2",
     "utilization.crossbar.cells_physical x weight_bits",
    ...
    ("e_mac", ARRAY, ENERGY, "pJ", "utilization.crossbar.macs",
     "Array energy of one multiply-accumulate, excluding conversion and periphery."),
    ("t_array_read", ARRAY, TIME, "ns", "schedule.pass_count",
    ...
    ("adc_sharing_factor", PERIPHERY, DIMENSIONLESS, "columns", "adc_count",
     "Array columns multiplexed onto one ADC; sets how many converters a crossbar needs."),
    ("e_adc_conversion", PERIPHERY, ENERGY, "pJ", "traffic.conversions",
     "Energy of one analog-to-digital conversion."),
    ("t_adc_conversion", PERIPHERY, TIME, "ns", "traffic.conversions",
     "Wall time of one analog-to-digital conversion."),
    ("area_per_row_driver", PERIPHERY, AREA, "um^2", "utilization.crossbar.axons_physical",
     "Silicon area of one row (axon) driver."),
    ("e_row_drive", PERIPHERY, ENERGY, "pJ", "traffic.boundaries.total_count",
     "Energy to drive one row line for one activation."),
    # --- neuron: soma state and update -----------------------------------------------
    ("area_per_neuron_logic", NEURON, AREA, "um^2", "utilization.crossbar.neurons_physical",
    ...
    ("p_host", HOST, POWER, "W", "timing.latency.host_ops_s",
    ...
    ("host_compute_rate", HOST, DIMENSIONLESS, "fraction", "timing.latency.host_ops_s",
    ...
    ("e_synaptic_event_total", AGGREGATE, ENERGY, "pJ", "utilization.crossbar.macs",
