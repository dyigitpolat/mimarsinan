...
| `ttfs_executor.py` | `TtfsAnalyticalExecutor` | Canonical TTFS segment semantics (HCM, `record_ttfs_hcm_reference`, SANA-FE preset/buffer). |
...
| `ttfs_recorder.py` | `TtfsRunRecord`, `compare_ttfs_records` | TTFS activation parity records. |
