...
DEFAULT_PLATFORM_CONSTRAINTS: Dict[str, object] = {
    ...
    # [ODIN P6] signedness is declared beside the width it qualifies, so the
    # membrane arithmetic falls out of the PAIR; false = the unsigned register.
    "membrane_bits": 0,
...
CONFIG_KEYS_SET: Set[str] = {
    "core_value_granularity", "degradation_tolerance", "spiking_family", "spiking_variant", "spiking_mode", "firing_mode",
    "spike_generation_mode", "encoding_layer_placement", "negative_value_shift", "thresholding_mode",
    "spike_encoding_seed", "cycle_accurate_lif_forward", "model_config_mode", "hw_config_mode",
    "activation_scale_quantile", "kd_ce_alpha", "kd_temperature", "activation_quantization", "weight_quantization",
    "pruning", "pruning_fraction", "prune_sparsity", "elimination_propagation", "elimination_constant_folding",
    "prune_criterion", "prune_group_size", "scale_migration", "scale_migration_clip_ratio", "weight_source",
    ...
    "s_allocation_explicit", "s_allocation_budget", "ttfs_genuine_blend_ce_alpha", "finetune_epochs", "finetune_lr",
    "batch_size", "tuning_batch_size", "preprocessing", "training_recipe", "tuning_recipe",
    "activation_analysis_batch_size", "generate_visualizations", "max_simulation_samples",
    "deployment_metric_full_eval", "eval_max_samples", "seed", "enable_nevresim_simulation",
    "nevresim_connectivity_mode", "enable_loihi_simulation", "enable_sanafe_simulation", "enable_training_noise",
    "ttfs_cycle_schedule", "ttfs_finetune_kd_against_rung2", "scm_degradation_tolerance", "nf_scm_parity_samples",
    "nf_scm_parity_atol", "nf_scm_parity_max_mismatch_fraction", "nf_scm_parity_min_agreement",
    ...
    "lif_membrane_readout", "lif_affine_fold", "lif_exact_qat", "lif_exact_qat_walk_recovery", "ttfsq_exact_qat",
    "casc_exact_qat", "lif_exact_qat_kd", "lif_aq_negative_boundary", "lif_per_hop_retiming",
    ...
    "endpoint_target_floor", "origin_teacher_kd", "origin_anchored_compact", "spike_phase_dither", "lif_membrane_init",
    ...
    "membrane_signed", "weight_sign_granularity",
    ...
    "input_data_scale", "eval_subsample_target", "tuning_step_cap_epochs", "calibration_set_policy", "prefix_stage_lr",
    "endpoint_floor_lr", "platform_physics_profile", "platform_physics_overrides",
}
