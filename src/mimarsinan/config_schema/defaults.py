...
CONFIG_KEYS_SET: Set[str] = {
    ...
    "max_simulation_samples", "deployment_metric_full_eval", "eval_max_samples",
    "seed",
    ...
    "lif_membrane_readout", "lif_affine_fold", "lif_exact_qat", "ttfsq_exact_qat",
    "casc_exact_qat", "lif_exact_qat_kd", "lif_aq_negative_boundary", "lif_per_hop_retiming", "lif_depth_balancing_relays",
    ...
    "spike_count_parity_samples", "aa_endpoint_recovery_steps", "tuning_lossless_entry_fast_path", "endpoint_target_margin", "activation_scale_policy", "core_semantics",
