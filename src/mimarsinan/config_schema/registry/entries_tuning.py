...
ENTRIES = (
    ...
    _E("s_aware_theta_quantile", domain="event", group="tuning", owner="activation_analysis",
    ...
    _E("ttfs_genuine_blend_ce_alpha", domain="event", group="tuning", owner="ttfs_adaptation",
    ...
    _E("ttfs_finetune_kd_against_rung2", domain="event", group="tuning", owner="ttfs_adaptation",
    ...
    _E("sync_first_moment_fold", domain="event", group="tuning",
    ...
    _E("lif_exact_qat_kd", domain="event", group="tuning", owner="lif_exact_qat_kd",
       type=T.BOOL, category=Category.ADVANCED, exposure="user",
    ...
    _E("lif_aq_negative_boundary", domain="event", group="tuning", owner="lif_aq_negative_boundary",
       type=T.BOOL, category=Category.ADVANCED, exposure="user",
    ...
    _E("ttfsq_exact_qat", domain="event", group="tuning", owner="ttfsq_exact_qat",
       type=T.BOOL, category=Category.ADVANCED, exposure="user",
    ...
    _E("casc_exact_qat", domain="event", group="tuning", owner="casc_exact_qat",
       type=T.BOOL, category=Category.ADVANCED, exposure="user",
    ...
    _E("lif_affine_fold", domain="event", group="tuning", owner="lif_affine_fold",
