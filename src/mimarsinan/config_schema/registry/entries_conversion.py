...
ENTRIES = (
    ...
    _E("activation_scale_quantile", group="conversion", owner="activation_analysis",
       ...
       bounds=(0.0, 1.0)),
    _E("activation_analysis_batch_size", group="conversion", owner="activation_analysis",
    ...
    _E("ttfs_genuine_blend_ce_alpha", group="conversion", owner="ttfs_adaptation",
       ...
       bounds=(0.0, 1.0)),
    _E("ttfs_finetune_kd_against_rung2", group="conversion", owner="ttfs_adaptation",
    ...
    _E("enable_training_noise", group="conversion", owner="noise_adaptation",
    ...
    _E("s_allocation", group="conversion", owner="TemporalAllocation",
    ...
    _E("s_allocation_explicit", group="conversion", owner="TemporalAllocation",
    ...
    _E("s_allocation_budget", group="conversion", owner="TemporalAllocation",
