...
| `wizard/config_builder.py` | `build_deployment_config_from_state` | Canonical wizard config builder: defaults, `apply_preset`, `derive_deployment_parameters` (Python parity with `wizard.js`). |
