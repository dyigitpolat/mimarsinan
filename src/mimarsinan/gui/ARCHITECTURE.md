...
| `wizard/schema.py` | `get_wizard_nas_schema`, `get_pipeline_step_names_for_config` | NAS field defaults (e.g. `pop_size=12`, `generations=5`) aligned with pipeline step; exposed at `GET /api/wizard/schema`. |
