...
class ImportedDataProvider:
    def __init__(self, dataprovider_path, dataprovider_class_name):
        self._dataprovider_class_path = dataprovider_path
        self._dataprovider_class_name = dataprovider_class_name
        self._dataprovider = _import_class_from_path(dataprovider_path, dataprovider_class_name)()
    ...
    def __setstate__(self, state):
        ...
        self._dataprovider = _import_class_from_path(state['_dataprovider_class_path'], state['_dataprovider_class_name'])()
