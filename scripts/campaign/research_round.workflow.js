...
const survey = await agent(
  ...
  + 'groups "untagged" and anything matching ws6_seed_matrix — known confounds), runs/campaign/ledger.jsonl '
...
const synth = await agent(
  ...
  + 'Edit/Write; do not rewrite existing sections. (3) PROPOSE next-round GPU work that advances the golden-standard '
  + 'AC table (read docs/mimarsinan_closeout_analysis_v2.md §8 if useful): append DISABLED plan_stage batches '
